    ...
    while( $result = $stmt->fetch(PDO::FETCH_ASSOC)){ 
        ...
        $view .= '<div class="col-sm-6"><div class="box"><img src="upload/'.$result["my_pic"].'" alt="" class="user">'.$star//.$result["id"]."</td><td>"
                ...
                .'<p style="width:400px;">'.$com.'</p>'.'
                    <img src="upload_restrant/'.$result["rest_pic"].'" style="width:400px;">
                    <form method="get" action="good.php">
                    <input type="hidden" name="num" value='.$result["id"].'>
                    <input type="hidden" name="pre_page" value='.$now_page.'>
                    <input type="submit" value="いいね" >いいね数'.$result["good"].'
                    </form><p style="margin:0px">投稿時間：'.$result["indate"].'
                    </p>' ;
...
<div class='container'>
    ...
    <a href="http://localhost/09_submit/select.php?page=1">Topへ</a>
